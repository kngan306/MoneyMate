...
class XacThucQuenMatKhau extends StatefulWidget {
  const XacThucQuenMatKhau({Key? key}) : super(key: key);

  @override
  State<XacThucQuenMatKhau> createState() => _XacThucQuenMatKhauState();
}

class _XacThucQuenMatKhauState extends State<XacThucQuenMatKhau> {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          // Navigator.pushNamed(context, '/taomatkhaumoi');
                          Navigator.push(
                            context,
                            MaterialPageRoute(
