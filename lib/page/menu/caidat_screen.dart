...
class CaiDat extends StatelessWidget {
  ...
  // Hàm hiển thị SnackBar khi tính năng chưa được hỗ trợ
  void _showNotSupportedSnackBar(BuildContext context) {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                // Bọc SettingsItem trong GestureDetector
                GestureDetector(
                  onTap: () => _showNotSupportedSnackBar(context),
                  child: SettingsItem(
                    title: 'Thay đổi ngôn ngữ',
                    value: 'Tiếng Việt',
                    icon: 'assets/images/arrow2_icon.png',
                    hasBorder: true,
                  ),
                ),
                GestureDetector(
