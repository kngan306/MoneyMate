    ...
    return MaterialApp(
        home: Scaffold(
            appBar: AppBar(
              ...
              leading: Builder(
                builder: (context) => IconButton(
                  ...
                  onPressed: () {
                    Scaffold.of(context)
                        .openDrawer(); // Mở drawer khi nhấn icon menu
                  },
                ),
              ),
            ),
            ...
            bottomNavigationBar: ConvexAppBar(
              backgroundColor: Color(0xFF1E201E), // Màu nền
              activeColor: Colors.white, // Màu icon khi được chọn
              color: Colors.white70, // Màu icon mặc định
              style: TabStyle.fixedCircle,
              height: 60,
              curveSize: 80, // Giảm kích thước đường cong hơn nữa
              top: -15,
              items: [
